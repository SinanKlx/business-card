...
const pages = {
    'home': {
        ...
        scripts: ['slideshow.js']  // Optional: Seitenspezifische Skripte
    },
    'about': {
        element: document.getElementById('page-about'),
        title: 'CV Sinan Kilic - About Me',
        scripts: []
    },
    'cv': {
        element: document.getElementById('page-cv'),
        title: 'CV Sinan Kilic - Professional Career',
        scripts: []  // Scroll-Animation ist im main.js integriert
    },
    'training': {
        element: document.getElementById('page-training'),
        title: 'CV Sinan Kilic - Training',
        scripts: []
    },
    'contact': {
    ...
    'experience': {
        element: document.getElementById('page-experience'),
        title: 'CV Sinan Kilic - Work Experience',
        scripts: []
    }
};
...
function runPageScripts(pageId) {
    // Für CV-Seite: Scroll-Animation starten
    if (pageId === 'cv') {
        setTimeout(() => {
            initScrollAnimation();
        }, 100);
    ...
    // Für Home-Seite: Slideshow starten
    if (pageId === 'home') {
        setTimeout(() => {
            initSlideshow();
        }, 100);
